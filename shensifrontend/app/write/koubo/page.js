...
export default function LiveBroadcastCopyGenerator () {
  ...
  return (
    <div>
      <Navbar title='Shensi-AI写作-AI口播稿生成器'></Navbar>
      <div className="flex flex-col items-center justify-center min-h-screen bg-blue-100 p-4">
        <div className="w-full max-w-3xl bg-white rounded-lg shadow-xl p-6">
          <p className="mb-6 text-gray-500">AI口播稿生成器，一键生成语言生动、内容详实的带货视频口播稿文案</p>
